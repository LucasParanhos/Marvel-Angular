...
import { HeroModel, PageModel } from 'src/app/models';
import { HeroesService } from '../heroes.service';
import { HeroesListComponent } from './heroes-list.component';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';

class MockHeroesService {
  public heroesApi = new MockHeroesApi();
}

class MockHeroesApi {
  query(params: HttpParams): Observable<PageModel<HeroModel>> {
    return new Observable((observer) => {
      observer.next({
        ...
        etag: '5d4dabd7d36efc563b2526a4089b4163171dbf7a',
        data: {
          offset: 0,
          limit: 10,
          total: 1562,
          ...
          results: [
            {
              ...
              urls: [
                {
                  type: 'detail',
                  url: 'http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=591905a5a119e688ad7740d924ad3172',
                },
                {
                  type: 'wiki',
                  url: 'http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=591905a5a119e688ad7740d924ad3172',
                },
                {
                  type: 'comiclink',
                  url: 'http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=591905a5a119e688ad7740d924ad3172',
                },
              ],
            },
            {
              ...
              urls: [
                {
                  type: 'detail',
                  url: 'http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=591905a5a119e688ad7740d924ad3172',
                },
                {
                  type: 'comiclink',
                  url: 'http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=591905a5a119e688ad7740d924ad3172',
                },
              ],
            },
          ],
...
describe('HeroesListComponent', () => {
  ...
  it('should query the heroes', () => {
    expect(component.model.length).toBe(2);
  });

  it('should search the heroes when the input is given', () => {
    let spyChangeFunction = spyOn(component, 'searchHero');
    let input = fixture.nativeElement.querySelector('#search-bar');
    input.value = '3-D Man';
    input.dispatchEvent(new Event('change'));
    fixture.detectChanges();
    expect(spyChangeFunction).toHaveBeenCalled();
  });
});
